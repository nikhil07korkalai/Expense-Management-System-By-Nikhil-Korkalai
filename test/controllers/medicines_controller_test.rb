...
class MedicinesControllerTest < ActionController::TestCase
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post :create, medicine: { expairy_date: @medicine.expairy_date, medicine_name: @medicine.medicine_name, prise: @medicine.prise, selling_quantity: @medicine.selling_quantity, total_quantity: @medicine.total_quantity }
    end
  ...
  test "should update medicine" do
    patch :update, id: @medicine, medicine: { expairy_date: @medicine.expairy_date, medicine_name: @medicine.medicine_name, prise: @medicine.prise, selling_quantity: @medicine.selling_quantity, total_quantity: @medicine.total_quantity }
    assert_redirected_to medicine_path(assigns(:medicine))
  end
